...
<div className="mb-16 text-center">
  ...
  <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-400">
    We design and curate memorable get-togethers that bring people closer
    through warmth, conversation, and shared moments. From intimate family
    gatherings to lively group meetups, every detail is thoughtfully planned
