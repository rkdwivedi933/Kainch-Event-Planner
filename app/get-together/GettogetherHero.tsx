...
const highlights: Highlight[] = [
  { icon: Heart, label: 'Personalized Kitty Party Planning' },
  { icon: Sparkles, label: 'Elegant Decor & Party Themes' },
  { icon: Camera, label: 'Fun Games & Photo Moments' },
  { icon: Users, label: 'Friendly Event Coordinators' }
];



const images: string[] = [
  'https://images.unsplash.com/photo-1561539623-007d71660044?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Z2V0JTIwdG9nZXRoZXJ8ZW58MHx8MHx8fDA%3D',
  'https://images.unsplash.com/photo-1516600164266-f3b8166ae679?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8Z2V0JTIwdG9nZXRoZXJ8ZW58MHx8MHx8fDA%3D',
  'https://plus.unsplash.com/premium_photo-1663012971986-ca9c8a0c832c?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8Z2V0JTIwdG9nZXRoZXJ8ZW58MHx8MHx8fDA%3D'
];


export default function GettogetherHero() {
...
<span className="text-[#C9A14A]">Get-Together Events</span>
</motion.h1>
...
>
  We create warm and memorable get-together events filled with great company,
  meaningful conversations, tasteful décor, and moments worth cherishing.
</motion.p>
