...
const ExhibitionDualSections: FC = () => {
  return (
      ...
      <div className="mx-auto max-w-7xl space-y-28">
        ...
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
          ...
          >
            ...
            <p className="mb-6 max-w-xl text-white/75 leading-relaxed">
              We create visually impactful exhibitions that help brands
              showcase products, ideas, and innovations in a powerful way.
            </p>

            <p className="max-w-xl text-white/70 leading-relaxed">
              From concept design to execution, every element is planned to
              attract attention, engage visitors, and elevate brand presence.
            </p>
          </motion.div>
        ...
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
          ...
          >
            ...
            <h2 className="mb-6 text-3xl font-extrabold text-white sm:text-4xl lg:text-5xl">
              Strategic{" "}
              <span className="text-[#C9A14A]">Layouts</span>{" "}
              & Seamless Execution
            </h2>

            <p className="mb-6 max-w-xl text-white/75 leading-relaxed">
              From stall fabrication and branding to lighting, graphics, and
              visitor flow, we manage every detail with precision.
            </p>

            <p className="max-w-xl text-white/70 leading-relaxed">
              Our exhibition team ensures smooth coordination, high footfall
              engagement, and a professional experience that delivers results.
            </p>
          </motion.div>
        </div>
...
export default ExhibitionDualSections;
