...
const highlights: Highlight[] = [
  { icon: LayoutGrid, label: 'Exhibition & Trade Show Design' },
  { icon: Briefcase, label: 'Brand Stalls & Product Showcases' },
  { icon: Sparkles, label: 'Premium Display & Experience' },
  { icon: Users, label: 'Visitor Flow & Engagement' }
];
    ...
    <section className="relative min-h-[90vh] overflow-hidden flex items-center justify-center px-6 md:px-12 lg:px-24 py-24 bg-[#0F0F0F]">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          ...
          that help brands showcase products, connect with audiences, and
          leave a lasting impression through immersive experiences.
        </motion.p>
