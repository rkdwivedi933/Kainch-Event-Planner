...
<h2 className="mb-6 text-3xl font-extrabold text-white sm:text-4xl lg:text-5xl">
  Crafting{" "}
  <span className="text-[#C9A14A]">Elegant</span>{" "}
  Kitty Party Experiences
</h2>

<p className="mb-6 max-w-xl text-white/75 leading-relaxed">
  Every kitty party is a celebration of friendship, fun, and togetherness.
  We design gatherings that reflect your style with creativity, laughter,
  and flawless execution.
</p>

<p className="max-w-xl text-white/70 leading-relaxed">
  From planning to the final toast, our team ensures every detail comes
  together seamlessly for a truly delightful kitty party experience.
</p>
          ...
          >
            <Image
              src="https://plus.unsplash.com/premium_photo-1711392741145-27815ca61e1c?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8a2l0aSUyMHBhcnR5fGVufDB8fDB8fHww"
        ...
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
          ...
          >
            <Image
              src="https://images.unsplash.com/photo-1645730826845-cd2ddec9984f?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fGtpdGklMjBwYXJ0eXxlbnwwfHwwfHx8MA%3D%3D"
...
<p className="mb-6 max-w-xl text-white/75 leading-relaxed">
  We believe beautiful kitty parties are built on thoughtful details. From
  décor and themes to games, seating, and guest experience, every element is
  curated to feel elegant, joyful, and effortless.
</p>

<p className="max-w-xl text-white/70 leading-relaxed">
  Our experienced team blends creativity and coordination to ensure your
  kitty party flows smoothly, remains stress-free, and is enjoyed by
  everyone.
</p>
