        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="group relative z-50">
            <motion.span
              ...
              className="font-serif text-xl font-light tracking-wide text-white transition-colors duration-300 group-hover:text-[#C9A14A] lg:text-2xl"
            >
              Kainch Event Planner
            </motion.span>
            <motion.div className="absolute -bottom-1 left-0 h-px w-0 bg-linear-to-r from-[#C9A14A] to-transparent transition-all duration-300 group-hover:w-full" />
          </Link>
                ...
                <li key={link.href}>
                  <Link
                    ...
                    className={`py-2 text-sm uppercase tracking-wider ${
                      isActive ? "text-[#C9A14A]" : "text-white hover:text-[#C9A14A]"
                    }`}
                  >
                    {link.label}
                  </Link>
          ...
          <li key={link.href}>
            {link.children ? (
              <>
                ...
                >
                  {link.label}
                  <span className="text-xl font-bold">{openServiceMobile ? "−" : "+"}</span>
                </button>
