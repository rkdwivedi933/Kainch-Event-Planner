...
const highlights: Highlight[] = [
  { icon: Mic2, label: 'Open Mic Performances' },
  { icon: Music, label: 'Singers, Poets & Comics' },
  { icon: Sparkles, label: 'Creative & Intimate Vibes' },
  { icon: Users, label: 'Community & Crowd Engagement' }
];

const images: string[] = [
  'https://images.unsplash.com/photo-1515162305281-9e6d3d5c1b77?w=1600&auto=format&fit=crop&q=80',
  'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=1600&auto=format&fit=crop&q=80',
  'https://images.unsplash.com/photo-1506157786151-b8491531f063?w=1600&auto=format&fit=crop&q=80'
];

export default function OpenMicHero() {
    ...
    <section className="relative min-h-[90vh] overflow-hidden flex items-center justify-center px-6 md:px-12 lg:px-24 py-24 bg-[#0F0F0F]">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          ...
          <span className="text-[#C9A14A]">Mic Nights</span>
        </motion.h1>
        ...
        >
          A stage for raw talent, real stories, and pure expression. Our open mic
          nights bring together singers, poets, comedians, and creators to
          share moments that truly connect.
        </motion.p>
