...
const highlights: Highlight[] = [
  { icon: Heart, label: 'Personalized Birthday Planning' },
  { icon: Sparkles, label: 'Creative Decor & Party Themes' },
  { icon: Camera, label: 'Fun & Memorable Moments' },
  { icon: Users, label: 'Professional Event Team' }
];


const images: string[] = [
  'https://images.unsplash.com/photo-1741969494307-55394e3e4071?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8YmlydGhkYXklMjBkZWNvcmF0aW9ufGVufDB8fDB8fHww',
  'https://images.unsplash.com/photo-1604668915840-580c30026e5f?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8YmlydGhkYXklMjBkZWNvcmF0aW9ufGVufDB8fDB8fHww',
  'https://plus.unsplash.com/premium_photo-1663090585707-96572044e509?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8YmlydGhkYXklMjBkZWNvcmF0aW9ufGVufDB8fDB8fHww'
];
...
>
  ...
  <span className="text-[#C9A14A]">Birthday Events</span>
</motion.h1>
...
>
  We create joyful birthday celebrations filled with fun, creativity,
  vibrant décor, and unforgettable moments.
</motion.p>
