...
const highlights: Highlight[] = [
  { icon: Heart, label: 'Dream Wedding Planning' },
  { icon: Sparkles, label: 'Luxury Decor & Themes' },
  { icon: Camera, label: 'Candid & Cinematic Moments' },
  { icon: Users, label: 'Expert Wedding Team' }
];
...
const images: string[] = [
  ...
  'https://images.unsplash.com/photo-1583878545126-2f1ca0142714?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fGluZGlhbiUyMHdlZGRpbmd8ZW58MHx8MHx8fDA%3D',
  'https://images.unsplash.com/photo-1587271407850-8d438ca9fdf2?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8aW5kaWFuJTIwd2VkZGluZ3xlbnwwfHwwfHx8MA%3D%3D'
];
    ...
    <section className="relative min-h-[90vh] overflow-hidden flex items-center justify-center px-6 md:px-12 lg:px-24 py-24 bg-[#0F0F0F]">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          ...
          <span className="text-[#C9A14A]">Wedding Events</span>
        </motion.h1>
